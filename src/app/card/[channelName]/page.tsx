...
import { generateChannelMetadata } from '@/lib/generateGroupMetadata';
        ...
        <div className="mb-6 flex flex-col items-center text-center gap-4">
          {channelInfo && (
            <>
              ...
              <ScrollArea className="h-20 w-full bg-[#111827]/60 px-4 py-2 text-left text-gray-500 text-[10px] sm:text-xs shadow-inner mx-auto">
...
export async function generateMetadata({
  ...
  return generateChannelMetadata({
    params: Promise.resolve(awaitedParams),
