...
export default function Header() {
  return (
    <header className="relative overflow-hidden flex items-center justify-between px-2 md:px-6 bg-[url('/header.png')] bg-no-repeat bg-right bg-center bg-[length:50%]">
